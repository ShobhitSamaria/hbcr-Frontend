...
check("Registration Number is auto-generated (no validation needed)", () => {
  const errs = validateStep1({});
  // Registration number is now auto-generated by the backend, so no validation error
  noError(errs, "Registration Number");
});
...
check("date of first diagnosis CAN precede date of reporting (allowed)", () => {
  const errs = validateStep1({
...
check("fully populated step 1 produces no errors", () => {
  const errs = validateStep1({
    ...
    "Duration of Stay at the above address (in years)": "10",
    "a). Aadhaar number": "123456789012",
    "b). ABHA number": "12345678901234",
    "19. Relationship to Cancer / Degree of Relationship": "No",
  });
